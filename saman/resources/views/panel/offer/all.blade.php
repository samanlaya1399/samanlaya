                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">جدول پیشنهادات ویژه</h3>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        {{jdate($product->expire)->format(' H:i:s - Y/m/d')}} </td>
                                        <td>
                                            <form action="{{ route('offer.destroy'  , ['id' => $product->id]) }}" method="post">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
                                                <div class="btn-group btn-group-xs">
                                                    <a href="{{ route('offer.edit' , ['id' => $product->id]) }}"  class="btn btn-primary">ویرایش</a>
