                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('sms.action.simple') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">گیرنده </label>
                                        @if($number != null)
                                            <input type="text" name="number" class="form-control" id="exampleInputEmail1" value="{{$number}}" placeholder="شماره را وارد کنید">
                                        @else
                                            <input type="text" name="number" class="form-control" id="exampleInputEmail1" placeholder="شماره را وارد کنید">
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">متن پیامک</label>
                                        <textarea rows="5" class="form-control" name="message" id="description" placeholder="توضیحات را وارد کنید">{{ old('description') }}</textarea>
                                    </div>
