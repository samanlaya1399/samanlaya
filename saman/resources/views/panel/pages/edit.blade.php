                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('information.update', ['id' => $information->id]) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="عنوان را وارد کنید" value="{{$information->title}}">
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="description" class="control-label">توضیحات کوتاه</label>
                                            <textarea rows="5" class="form-control" name="description" id="description" placeholder="توضیحات را وارد کنید">{{ $information->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label for="body" class="control-label">متن</label>
                                            <textarea rows="5" class="form-control" name="body" id="body" placeholder="متن مقاله را وارد کنید">{{ $information->body }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-8">
                                        <label for="exampleInputEmail1">تگ </label>
                                        <input name="tags" type="text" class="tagator" data-tagator-use-dimmer="true" data-tagator-autocomplete="['لباس']" value="{{$information->tags}}">
                                        <label for="exampleInputEmail1">کلید </label>
                                        <input name="key" type="text"  value="{{$information->key}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="row">
                                            @if(isset($information->images['images']))
                                            @foreach( $information->images['images'] as $key => $image)
                                                <div class="col-sm-2">
                                                    <label class="control-label">
                                                        {{ $key }}
                                                        <input type="radio" name="imagesThumb" value="{{ $image }}" {{ $information->images['thumb'] == $image ? 'checked' : '' }} />
                                    ...
                                    <div class="form-group" style="display: flex;">
                                        <div class="col-sm-4 col-md-2">
                                            ...
                                            <input type="text" class="form-control" pattern="[0-9]{2}" maxlength="2" size="2" name="day" id="day" placeholder="روز" value="{{ jdate($information->created_at)->format('%d')  }}">
                                        </div>
                                        <div class="col-sm-4 col-md-2">
                                            ...
                                            <select name="month" id="month" class="form-control" title="زمان ثبت خبر"  data-live-search="true">
                                                @foreach($month_array as $i => $month)
                                                    <option value="{{$month_num[$i]}}" @if ($month===jdate($information->created_at)->format('%B')) selected  @endif>{{$month}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-md-2">
                                            ...
                                            <input type="text" class="form-control" name="year" id="year" size="4" maxlength="4" placeholder="سال" value="{{ jdate($information->created_at)->format('%Y')  }}">
                                        </div>
                                    ...
                                    <div class="form-group" style="display: flex;">
                                        <div class="col-sm-4 col-md-2">
                                            ...
                                            <input type="text" class="form-control" pattern="[0-9]{2}" maxlength="2"  name="hour" id="hour" placeholder="ساعت" value="{{ jdate($information->created_at)->format('H')  }}">
                                        </div>
                                        <div class="col-sm-4 col-md-2">
                                            <label for="created" class="control-label">دقیقه</label>
                                            <input type="text" class="form-control" pattern="[0-9]{2}" maxlength="2" size="2" name="min" id="min" placeholder="دقیقه" value="{{ jdate($information->created_at)->format('i')  }}">
                                        </div>
                                    </div>
