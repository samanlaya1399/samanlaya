                            ...
                            <form class="form-horizontal" action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title" placeholder="عنوان را وارد کنید" {{ old('title') }}>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <select name="category" id="grouping"  class="form-control select" title="بخش مورد نظر را انتخاب کنید"  data-live-search="true" >
                                             ...
                                             @foreach($categories as $grouping)
                                                ...
                                                <option value="{{$grouping->id}}" @if( old('category') == $grouping->id) selected @endif>{{$grouping->name}}</option>
                                             @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tags" type="text" class="tagator" data-tagator-use-dimmer="true" data-tagator-autocomplete="['لباس']" {{ old('tags') }}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
