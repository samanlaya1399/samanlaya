                            ...
                            <form class="form-horizontal" action="{{ route('roles.update',['id'=>$role->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="عنوان را وارد کنید" value="{{$role->name}}">
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control" name="label" id="description" placeholder="توضیحات را وارد کنید">{{ $role->label }}</textarea>
                                    </div>
                                </div>
                                <!-- /.card-body -->
