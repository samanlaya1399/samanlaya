                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"> ثبت ویژگی محصول</h3>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select name="type_id" id="category" class="form-control" title="بخش مورد نظر را انتخاب کنید"  data-live-search="true" >
                                                @foreach($types as $group)
                                                    <option value="{{$group->id}}" >{{$group->title .' - '. $group->grouping()->first()->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
