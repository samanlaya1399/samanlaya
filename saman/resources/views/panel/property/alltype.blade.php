                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">انواع محصولات ثبت شده</h3>
...
<div class="col-md-12" style="padding: 10px;">
                            ...
                            <div class="col-md-2 dis-inb">
                                <a href="{{route('allpro.index',['id'=>$brand->id])}}">
                       <button class="btn btn-block btn-outline-primary" title="{{$brand->grouping->title .' - '.$brand->description}}">
                          {{$brand->title}}
                       </button>
                                </a>
                            </div>
